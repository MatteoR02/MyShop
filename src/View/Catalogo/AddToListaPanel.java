...
public class AddToListaPanel extends JPanel {
    ...
    public AddToListaPanel(JDialog dialog, ArrayList<ListaAcquisto> liste, ComponenteCatalogo comp){
        ...
        CatalogoListener catalogoListener = CatalogoListenerBuilder.newBuilder(null).dialog(dialog).compCatalogo(comp).
                comboBoxListe(listeDropDown).spinnerQuantita(quantitaSpinner).build();
