...
public class CreaProdottoCompositoPanel extends JPanel {
    ...
    public CreaProdottoCompositoPanel(JFrame frame, PuntoVendita pv, boolean modifica, ComponenteCatalogo comp) {
        ...
        AdminListener adminListener = AdminListenerBuilder.newBuilder((MainPage) frame).fieldNome(fieldNome).
                fieldDescrizione(fieldDescrizione).comboBoxCategoria(selCategoriaBox).comboBoxErogatore(selErogatoriBox).
                labelImmagini(labelAllegato).tableProdotti(table).build();
