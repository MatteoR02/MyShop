...
public class CreaPuntoVenditaPanel extends JPanel {
    ...
    public CreaPuntoVenditaPanel(JFrame frame) {
        ...
        AdminListener adminListener = AdminListenerBuilder.newBuilder((MainPage) frame).fieldNome(fieldNome).fieldNazione(fieldNazione).
                fieldCitta(fieldCitta).fieldCap(fieldCap).fieldVia(fieldVia).fieldCivico(fieldCivico).build();
