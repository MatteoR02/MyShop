...
public class PrenotazioniManagerPanel extends JPanel {

    public PrenotazioniManagerPanel(MainPage frame, ArrayList<Prenotazione> prenotazioni){
            ...
            list.getSelectionModel().addListSelectionListener(new ListSelectionListener() {
                ...
                public void valueChanged(ListSelectionEvent e) {
                    if(!e.getValueIsAdjusting()) {
                        ...
                        listaPanel.add(new PrenotazioniManagerTablePanel((pr), frame));
                        frame.repaint();
                        frame.validate();
                    }
                }
